...
export function useColumns() {
  // editMap 是用来存储原始数据的
  const editMap: Ref<Record<number, { editable: boolean } & Option>> = ref({});
  const dataList: Ref<Option[]> = ref([]);
  ...
  function openDialog() {
    addDialog({
      ...
      beforeSure: (done, { options }) => {
        ...
        const curData = options.props.formInline as Option;
