...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.userDo.UseModel(&gorm_gen.User{})
...
type IUserDo interface {
	...
	Unscoped() IUserDo
	Create(values ...*gorm_gen.User) error
	CreateInBatches(values []*gorm_gen.User, batchSize int) error
	Save(values ...*gorm_gen.User) error
	First() (*gorm_gen.User, error)
	Take() (*gorm_gen.User, error)
	Last() (*gorm_gen.User, error)
	Find() ([]*gorm_gen.User, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gorm_gen.User, err error)
	FindInBatches(result *[]*gorm_gen.User, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*gorm_gen.User) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*gorm_gen.User, error)
	FirstOrCreate() (*gorm_gen.User, error)
	FindByPage(offset int, limit int) (result []*gorm_gen.User, count int64, err error)
...
func (u userDo) Create(values ...*gorm_gen.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) CreateInBatches(values []*gorm_gen.User, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userDo) Save(values ...*gorm_gen.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) First() (*gorm_gen.User, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*gorm_gen.User), nil
	}
}

func (u userDo) Take() (*gorm_gen.User, error) {
...
func (u userDo) Last() (*gorm_gen.User, error) {
...
func (u userDo) Find() ([]*gorm_gen.User, error) {
	result, err := u.DO.Find()
	return result.([]*gorm_gen.User), err
}

func (u userDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gorm_gen.User, err error) {
	buf := make([]*gorm_gen.User, 0, batchSize)
...
func (u userDo) FindInBatches(result *[]*gorm_gen.User, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userDo) FirstOrInit() (*gorm_gen.User, error) {
...
func (u userDo) FirstOrCreate() (*gorm_gen.User, error) {
...
func (u userDo) FindByPage(offset int, limit int) (result []*gorm_gen.User, count int64, err error) {
...
func (u userDo) Delete(models ...*gorm_gen.User) (result gen.ResultInfo, err error) {
