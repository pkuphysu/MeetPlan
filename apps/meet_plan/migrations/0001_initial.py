    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allow_other',
                 models.BooleanField(choices=[(False, '不允许'), (True, '允许')], default=True, help_text='是否可两人同时进行综合指导课',
                                     max_length=1, verbose_name='允许多人')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meet_plan',
                 models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='meet_plan.meetplan')),
                ('student',
                 models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('have_checked',
                 models.BooleanField(choices=[(False, '待回应'), (True, '已回应')], default=False, max_length=1,
                                     verbose_name='是否已经处理')),
                ('teacher',
                 models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
