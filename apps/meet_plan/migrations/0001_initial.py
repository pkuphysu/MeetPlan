    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allow_other', models.BooleanField(choices=[(0, '不允许'), (1, '允许')], default=True, help_text='是否可两人同时进行综合指导课', max_length=1, verbose_name='允许多人')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meet_plan', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='meet_plan.MeetPlan')),
