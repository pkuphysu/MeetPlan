...
urlpatterns = [
    ...
    path('baseprofile_add/', views.BaseProfileAddView.as_view(), name='userprofile_add'),
    ...
    path('userprofileimg_upload/', views.BaseProfileImgUpdateView.as_view(), name='userprofileimg_add'),
