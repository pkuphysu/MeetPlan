    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identity_id', models.CharField(db_index=True, max_length=16, unique=True, validators=[
                    django.core.validators.RegexValidator(message='账号格式错误。', regex='^\\d{8,12}$')],
                                                 verbose_name='职工号\\学号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department',
                 models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='account_auth.department',
                                   verbose_name='系所')),
            ],
            options={
                'verbose_name': '专业',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=17, validators=[
                    django.core.validators.RegexValidator(message='号码格式错误。座机请加区号', regex='^\\+?1?\\d{9,15}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=17, validators=[
                    django.core.validators.RegexValidator(message='号码格式错误。', regex='^\\+?1?\\d{9,15}$')])),
                ('dorm', models.CharField(max_length=32, verbose_name='宿舍')),
                ('department',
                 models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='account_auth.department',
                                   verbose_name='系所')),
                ('grade', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='account_auth.grade',
                                            verbose_name='年级')),
                ('major', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='account_auth.major',
                                            verbose_name='专业')),
                ('user',
                 models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL,
                                      verbose_name='学生')),
